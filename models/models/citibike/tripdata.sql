select
    ...
    payload:"end station latitude"::number(7,4)     as end_station_latitude,
    payload:"end station longitude"::number(7,4)    as end_station_longitude,
    ...
    payload:"start station latitude"::number(7,4)   as start_station_latitude,
    payload:"start station longitude"::number(7,4)  as start_station_longitude,
...
where usertype is not null
  and start_station_latitude between 40.0 and 42.0
